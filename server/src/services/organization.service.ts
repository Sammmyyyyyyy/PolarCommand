...
export class OrganizationService {
  ...
  public static async createOrganization(data: any, user?: any) {
  ...
  public static async getOrCreateDefaultOrganization() {
   ...
   */
  public static async getOrganizationOverview(organizationId: string) {
    ...
    const maintenanceDueAssets = allAssets.filter(
      (a) => a.lifecycleStatus === 'MAINTENANCE_DUE' || a.lifecycleStatus === 'UNDER_MAINTENANCE' || a.maintenanceInterval - a.operatingHours <= 0
    ).length;
