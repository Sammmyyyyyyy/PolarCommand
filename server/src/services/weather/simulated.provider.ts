import { WeatherProvider, RawWeatherData } from './weather.types.js';

export class DeterministicSimulatedWeatherProvider implements WeatherProvider {
  public readonly providerName = 'Simulated-Test-Provider';

  private mockData?: Partial<RawWeatherData>;

  constructor(mockData?: Partial<RawWeatherData>) {
    this.mockData = mockData;
  }

  public setMockData(mockData: Partial<RawWeatherData>) {
    this.mockData = mockData;
  }

  public async fetchWeather(lat: number, lon: number): Promise<RawWeatherData> {
