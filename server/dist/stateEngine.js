import { INITIAL_EXPEDITION, INITIAL_STATIONS, INITIAL_CARGO, INITIAL_INVENTORY, INITIAL_ASSETS, INITIAL_PERSONNEL, INITIAL_INCIDENTS, INITIAL_ALERTS, INITIAL_ACTIONS, } from './mockData.js';
import { calculateExpeditionRisk } from './riskEngine.js';
class StateEngine {
    expedition = JSON.parse(JSON.stringify(INITIAL_EXPEDITION));
    stations = JSON.parse(JSON.stringify(INITIAL_STATIONS));
    cargo = JSON.parse(JSON.stringify(INITIAL_CARGO));
    inventory = JSON.parse(JSON.stringify(INITIAL_INVENTORY));
    assets = JSON.parse(JSON.stringify(INITIAL_ASSETS));
    personnel = JSON.parse(JSON.stringify(INITIAL_PERSONNEL));
    ...
    simulateCargoDelay(cargoId, delayHours) {
    ...
    optimizeCargoAllocation(vehicleId) {
