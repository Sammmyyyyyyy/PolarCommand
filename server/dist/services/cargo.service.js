...
export class CargoService {
    static async listCargo(expeditionId, filter) {
    ...
    static async createCargo(expeditionId, data, user) {
    ...
    static async updateCargo(id, data, user) {
    ...
    static async deleteCargo(id, user) {
