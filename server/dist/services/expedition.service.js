...
export class ExpeditionService {
    ...
    static async getDashboardSummary(expeditionId) {
        ...
        const maintenanceDueAssets = expedition.assets.filter((a) => a.maintenanceInterval - a.operatingHours <= 0 || a.status === 'Maintenance').length;
