...
export class MovementService {
    ...
    static async updateMovementStatus(id, status, options, user) {
     ...
     */
    static async applyWeatherConstraint(movementId, weather, user) {
        ...
        return this.updateMovementStatus(movementId, newStatus, {
            delayHours,
